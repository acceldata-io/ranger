...
INSERT INTO x_db_version_h (version,inst_at,inst_by,updated_at,updated_by,active) VALUES ('077',UTC_TIMESTAMP(),'Ranger 2.8.0.3.4.3.0-1',UTC_TIMESTAMP(),'localhost','Y');
