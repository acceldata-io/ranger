...
additional_info CLOB DEFAULT NULL NULL,
PRIMARY KEY(id),
CONSTRAINT x_gds_shared_res_UK_name UNIQUE(data_share_id, name),
CONSTRAINT x_gds_shared_res_UK_resource_signature UNIQUE(data_share_id, resource_signature),
CONSTRAINT x_gds_shared_res_FK_added_by_id FOREIGN KEY(added_by_id) REFERENCES x_portal_user(id),
CONSTRAINT x_gds_shared_res_FK_upd_by_id FOREIGN KEY(upd_by_id) REFERENCES x_portal_user(id),
CONSTRAINT x_gds_shared_res_FK_data_share_id FOREIGN KEY(data_share_id) REFERENCES x_gds_data_share(id)
);
CREATE INDEX x_gds_shared_res_guid ON x_gds_shared_resource(guid);
CREATE INDEX x_gds_shared_res_data_share_id ON x_gds_shared_resource(data_share_id);
commit;
...
PRIMARY KEY(id),
CONSTRAINT x_gds_dshid_UK_ds_id_dataset_id UNIQUE(data_share_id, dataset_id),
...
CREATE INDEX x_gds_dshid_ds_id_dataset_id ON x_gds_data_share_in_dataset(data_share_id, dataset_id);
commit;
...
approver_id NUMBER(20) DEFAULT NULL NULL,
PRIMARY KEY(id),
CONSTRAINT x_gds_dip_UK_dataset_id_proj_id UNIQUE(dataset_id, project_id),
