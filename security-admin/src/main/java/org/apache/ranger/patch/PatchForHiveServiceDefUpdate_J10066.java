...
@Component
public class PatchForHiveServiceDefUpdate_J10066 extends BaseLoader {
    private static final Logger logger = LoggerFactory.getLogger(PatchForHiveServiceDefUpdate_J10066.class);
    ...
    public static void main(String[] args) {
        logger.info("main()");
        try {
            PatchForHiveServiceDefUpdate_J10066 loader = (PatchForHiveServiceDefUpdate_J10066) CLIUtil.getBean(PatchForHiveServiceDefUpdate_J10066.class);
            loader.init();
    ...
    public void execLoad() {
        logger.info("==> PatchForHiveServiceDefUpdate_J10066.execLoad()");
        try {
    ...
    public void printStats() {
        logger.info("PatchForHiveServiceDefUpdate_J10066 data ");
    }
